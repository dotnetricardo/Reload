...
namespace Reload
{
    ...
    public sealed class Reload : Package
    {
        ...
        private void HandleCommands(OleMenuCommandService mcs)
        {
            ...
            var extMenuItem = new MenuCommand(this.ShowExt, aboutCommandId);
            mcs.AddCommand(extMenuItem);
        ...
        private void ShowExt(object sender, EventArgs e)
        {
            var extForm = new ExtFrm();
            extForm.ShowInTaskbar = false;
